...
contract VotingEscrowTest is ExtendedBaseTest {
    function testVotingEscrowFlow() public {
        ...
        assertEq(locked.end, 63504000);
        assertEq(locked.isPermanent, false);
        assertEq(escrow.slopeChanges(63504000), -31709791983);

        assertEq(escrow.userPointEpoch(1), 1);
        userPoint = escrow.userPointHistory(1, 1);
        assertEq(userPoint.bias, 1994520531979318409); // (TOKEN_1 / MAXTIME) * 2 * (63504000 - 604801)
        assertEq(userPoint.slope, 31709791983);
        assertEq(userPoint.ts, 604801);
        assertEq(userPoint.blk, 1);
        assertEq(userPoint.permanent, 0);
        ...
        assertEq(escrow.epoch(), 1);
        globalPoint = escrow.pointHistory(1);
        assertEq(globalPoint.bias, 1994520531979318409); // (TOKEN_1 / MAXTIME) * 2 * (63504000 - 604801)
        ...
        assertEq(locked.end, 63504000);
        assertEq(locked.isPermanent, false);
        assertEq(escrow.slopeChanges(63504000), -47564687973);
        ...
        assertEq(userPoint.bias, 2991695181593523613); // slope * (63504000 - 608401)
        assertEq(userPoint.slope, 47564687973);
        ...
        assertEq(globalPoint.slope, 47564687973);
        ...
        assertEq(escrow.slopeChanges(64713600), -47564687973);

        assertEq(escrow.userPointEpoch(1), 3);
        // check prior point
        userPoint = escrow.userPointHistory(1, 2);
        assertEq(userPoint.bias, 2991695181593523613); // slope * (64713600 - 1818001)
        assertEq(userPoint.slope, 47564687973);
        assertEq(userPoint.ts, 608401);
        assertEq(userPoint.blk, 2);
        assertEq(userPoint.permanent, 0);
        ...
        assertEq(globalPoint.bias, 2977397260170883200); // slope * (64713600 - 2419200)
        assertEq(globalPoint.slope, 47564687973);
