...
import {StreetVotingRewardsFactory} from "contracts/factories/StreetVotingRewardsFactory.sol";
...
import {IMinter, StreetMinter} from "contracts/StreetMinter.sol";
...
import {IStreetToken, StreetToken} from "contracts/StreetToken.sol";
import {IVoter, StreetVoter} from "contracts/StreetVoter.sol";
import {VeArtProxy} from "contracts/VeArtProxy.sol";
import {IVotingEscrow} from "contracts/interfaces/IVotingEscrow.sol";
import {VeStreet} from "contracts/VeStreet.sol";
...
abstract contract Base is Script, Test {
    ...
    StreetVotingRewardsFactory public votingRewardsFactory;
    ManagedRewardsFactory public managedRewardsFactory;
    StreetVoter public voter;
    RewardsDistributor public distributor;
    StreetMinter public minter;
    ...
    /// @dev Treasury for StreetBribe platform fee (must be set before deployFactories for Street)
    ...
    function deployFactories() public {
        ...
        address _treasury = treasury != address(0) ? treasury : address(1);
        votingRewardsFactory = new StreetVotingRewardsFactory(_treasury);
