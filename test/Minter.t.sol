...
contract MinterTest is BaseTest {
    ...
    function testTailEmissionWhenWeeklyEmissionDecaysBelowTailStart() public {
        ...
        assertApproxEqRel(STREET.balanceOf(address(voter)), 9_059_747 * TOKEN_1, 1e12);
        ...
        minter.updatePeriod();
        assertApproxEqAbs(STREET.balanceOf(address(voter)), 430_810 * 1e18, TOKEN_1);
    ...
    function testMinterWeeklyDistribute() public {
        ...
        minter.updatePeriod();
        post = STREET.balanceOf(address(voter));
